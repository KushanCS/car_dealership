...
export default function VehicleDetail() {
  ...
  const mainImage = buildAssetUrl(
    vehicle.images?.[selectedImageIndex]?.url
  ) || `https://via.placeholder.com/600x400?text=${vehicle.brand}`;
      ...
      >
        ...
        <div>
          ...
          >
            <DetailStatCard
              label='Price'
              value={`LKR ${Number(vehicle.price || 0).toLocaleString()}`}
              accent='var(--primary)'
            />
