        ...
        >
          {vehicles.map(
            (vehicle) => {
              ...
              const statusMeta = getVehicleStatusMeta(
                vehicle.status
              );
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className='sub'
                      >
                        {vehicle.type || 'Type'} • {vehicle.year || 'Year not set'}
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <DetailRow
                        ...
                        value={
                          vehicle.details
                            ? `${vehicle.details.slice(0, 56)}${vehicle.details.length > 56 ? '...' : ''}`
                            : 'No details added'
                        }
                      />
                    </div>
                    ...
                    >
                      <button
                        ...
                        className='btn btnPrimary'
                        onClick={
                          () => bookNow(vehicle._id, vehicle.status)
                        }
